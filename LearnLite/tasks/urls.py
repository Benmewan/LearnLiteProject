...
urlpatterns  = [
    ...
    path('update/task/<int:task_id>/status/', views.update_task_status_to_true_view, name='update_task_status_to_true_view'),
    path('change/task/<int:task_id>/status/', views.update_task_status_to_false_view, name='update_task_status_to_false_view'),
